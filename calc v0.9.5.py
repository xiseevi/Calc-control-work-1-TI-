...
# from - поꙁволѧѥтъ импортировать часть библїѻтекꙑ.
# decimal -​ модуль​ десѧтичнꙑхъ ​чиселъ​ поꙁволѧѥтъ иꙁбежать неточностеи при вꙑполненїи ꙗрифметическꙑхъ ꙁадачъ (беꙁъ ​него​ ѿвѣтꙑ ​полѫчаѥтсѧ​ ​не​ ​точнꙑми​ ​не​ ​цельнꙑми​).

print('Калькоулѧторъ:')
# print('text') - функція вывода текста на экранъ 

def inpuCH1():
 # Поꙁволѧѥтъ ꙁапрашивать фоункцїю ​ввѫда​ числа ​въ​ раꙁнꙑхъ частѧхъ когда.
    try:
        ch1 = Decimal(input('Введите первоѥ число: '))
        return ch1
    except:
...
def inpuCH2():
    try:
        ch2 = Decimal(input('Введите ​втраѥ число: '))
        return ch2
    except:
        print('Введенныи ѥлементъ ​не​ явлѧѥтсѧ числомъ введите ​втраи​ ѥлементъ: ')
        return inpuCH2()
...
# функция калькулятор
    ...
    # зацикливаем программу.
        ...
        # эльф Ф == 6 - фоункцїꙗ логарифма (​ѧ​ ​въ​ ​доушѣ​ ​не​ ​ебу что такоѥ логарифмъ =) ).     
            try:
                ch1 = Decimal(input('введите логарифмъ: '))
            except:
                print('Введенныи ѥлементъ ​не​ явлѧѥтсѧ числомъ введите ​втраи​ ѥлементъ: ')
                ch1 = Decimal(input('введите логарифмъ: '))
            try:
                ch2 = Decimal(input('введите ​ѻснованїѥ​: '))
            except:
                print('Введенныи ѥлементъ ​не​ явлѧѥтсѧ числомъ введите ​втраи​ ѥлементъ: ')
                ch2 = Decimal(input('введите ​ѻснованїѥ​:: '))
            r = math.log(ch1, ch2)
